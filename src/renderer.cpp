...
void Renderer::UpdateWindowTitle(int score, int fps, int best_score) {
  std::string title{"Snake Score: " + std::to_string(score) + " " + "[Best score: " + std::to_string(best_score) + "]" + " FPS: " + std::to_string(fps)};
